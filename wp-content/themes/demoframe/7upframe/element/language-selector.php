...
if(defined('ICL_LANGUAGE_CODE') || class_exists('Polylang') || defined('QTX_VERSION')){
                ...
                default:
                    if(defined('ICL_SITEPRESS_VERSION')){
                        ...
                        foreach ($wpml_lang as $lang) {
                            ...
                            if($lang['active']){
                                ...
                                if($flag == 'yes') $lang_active .=     '<img alt="'.esc_attr__('flag','hama').'" src="'.esc_url($flag_url).'">';
                            ...
                            $lang_sub .=                '<li class="'.$l_class.'">
                                                            <a href="'.esc_url($url).'">';
                            if($flag == 'yes') $lang_sub .=     '<img alt="'.esc_attr__('flag','hama').'" src="'.esc_url($flag_url).'">';
                            $lang_sub .=                        $name;
                            $lang_sub .=                    '</a>
                                                        </li>';
                        }
                    ...
                    elseif(class_exists('Polylang')){
                        ...
                        if(defined('QTX_VERSION')){
                            ...
                            if(is_404()) $url = home_url('home'); else $url = '';
    ...
    vc_map( array(
        "name"          => esc_html__("Language Selector", 'hama'),
        "base"          => "s7upf_language_selector",
        "icon"          => "icon-st",
        "category"      => esc_html__("7UP-Elements", 'hama'),
        "description"   => esc_html__( 'Display language selector', 'hama' ),
        "params"    => array(
            array(
                "type"          => "dropdown",
                "admin_label"   => true,
                ...
                "value"         => array(
                    ...
                    esc_html__("Wpml style",'hama')        => 'wpml-style',
                    esc_html__("Polylang style",'hama')    => 'poly-style',
                ),
            ...
            array(
                "type"          => "dropdown",
                "admin_label"   => true,
                "heading"       => esc_html__("Show Flag",'hama'),
                "param_name"    => "flag",
                "value"         => array(
