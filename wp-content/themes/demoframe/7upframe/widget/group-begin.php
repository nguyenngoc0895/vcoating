...
if(!class_exists('S7upf_Group_Begin'))
{
    class S7upf_Group_Begin extends WP_Widget {
        ...
        function __construct() {
            ...
            parent::__construct( false, esc_html__('Group begin','hama'),
                array( 'description' => esc_html__( 'Begin a Group', 'hama' ), ));
        ...
        function form( $instance ) {
            ...
            ?>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'el_class' )); ?>"><?php esc_html_e( 'Wrap class:' ,'hama'); ?></label>
