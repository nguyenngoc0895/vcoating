...
?>
<div class="mini-cart-box mini-cart-style2 <?php echo esc_attr($el_class)?>">
    <?php 
    switch ($style) {
        case 'value':
            # code...
        ...
        default:
            ...
            <a class="mini-cart-link" href="<?php echo wc_get_cart_url()?>">
                <span class="mini-cart-icon title18"><span class="icon-inner cart-svg">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="20px" height="20px" viewBox="0 0 510 510" style="enable-background:new 0 0 510 510;" xml:space="preserve">
                        <g>
                            <g id="shopping-cart">
                ...
                <span class="mini-cart-text">
                    <span class="set-cart-number">0</span><?php echo esc_html_e("items","hama")?>
                </span>
            </a>
            <?php
            break;
