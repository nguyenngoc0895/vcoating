...
?>
<div class="mini-cart-box mini-cart-style4 <?php echo esc_attr($el_class)?>">
    <?php 
    switch ($style) {
        case 'value':
            # code...
        ...
        default:
            ...
            <a class="mini-cart-link" href="<?php echo wc_get_cart_url()?>">
                <span class="mini-cart-text">
                    <span class="set-cart-number">0</span>
                </span>
                <div class="mini-cart-icon title18 inline-block"><div class="inline-block"><div class="icon-inner cart-svg">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="18px" height="18px" viewBox="0 0 510 510" style="enable-background:new 0 0 510 510;" xml:space="preserve">
                        <g>
                            <g id="shopping-cart">
                ...
                <h3 class="minicart-h3"><?php echo esc_html_e("My cart","hama")?></h3>
            </a>
            <?php
            break;
    }
