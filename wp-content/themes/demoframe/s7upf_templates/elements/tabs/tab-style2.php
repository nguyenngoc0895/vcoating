...
<div class="tabs-block block-element tab-style2 <?php echo esc_attr($el_class)?> tab-ajax-<?php echo esc_attr($tab_ajax)?>">
	<div class="time-title">
        ...
        <?php } ?>
        <?php 
        	if(!empty($des)){ ?><p class="desc-block"><a href="<?php echo esc_url($linkdes);?>"><?php echo esc_html($des); ?></a></p>
        <?php } ?>
    </div>
