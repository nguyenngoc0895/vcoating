...
<div class="tabs-block block-element border-top5 <?php echo esc_attr($el_class)?> tab-ajax-<?php echo esc_attr($tab_ajax)?>">
	<?php    
        if(!empty($title)) echo '<h3 class="block-title title18 font-bold text-uppercase">'.esc_html($title).'</h3>';
