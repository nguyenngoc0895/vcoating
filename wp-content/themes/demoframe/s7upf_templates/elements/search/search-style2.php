<div class="block-element search1 search-popup block-search-element search-style2 <?php echo esc_attr($el_class)?>">
    <?php if(!empty($title)):?>
    ...
    <div class="submit-icon-search"></div>
    <div class="icon-search2"><span><i class="fa fa-search" aria-hidden="true"></i></span></div>
