...
if(isset($row_number)) $row_class = "list-col-item list-4-item show-style7 ".esc_attr($row_number);
if(isset($column)) $col_class = "list-col-item list-".esc_attr($column)."-item";
else $col_class = '';
?>	
<?php if (isset($row_number)) { ?>
<div <?php post_class($row_class)?>>
<?php }else { ?>
<div <?php post_class($col_class)?>>
<?php } ?>
	<div class="item-product item-product-grid grid-style6 style7">
